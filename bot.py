...
{{
  ...
  "price": число (ИТОГОВАЯ сумма по позиции = количество × цена за штуку, целое число, округли если дробное)
}}
...
- Пример: напечатано 1530, написано от руки 1468 → разница 62 → вычти 62 из самой дорогой позиции
