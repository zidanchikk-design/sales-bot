...
CATEGORY_KEYWORDS = {
    "Обувь": [
        "ботинк", "туфл", "сапог", "кроссовк", "кед", "мокасин", "полуботинк",
        "сандал", "балетк", "слипон", "тапк", "галош", "валенк", "угг",
        "пинетк", "чешк", "лапти", "сабо", "угги", "босоножк",
    ],
    "Одежда": [
        "куртк", "пальто", "платье", "брюк", "джинс", "костюм", "комбинез",
        "свитер", "кофт", "футболк", "шорт", "юбк", "водолазк", "толстовк",
        "рубашк", "варежк", "рукавиц", "шапк", "шарф", "перчатк", "колготк",
        "носк", "боди", "блузк", "джемпер", "жилет", "леггинс", "лонгслив",
        "майк", "ползунк", "распашонк", "слип", "комплект одежд", "дождевик",
        "бандана", "бант", "бейсболк", "галстук", "джеггинс", "жакет",
        "пижам", "плащ", "свитшот", "худи", "фартук", "флиск",
    ],
    "Книги": [
        "книг", "букварь", "азбук", "энциклопед", "сказк", "рассказ", "стих",
        "литератур", "учебник", "пособ", "раскраск", "книжк", "книга-активит",
        "мозаика-синтез", "мозайка-синтез", "росмэн", "умка", "карапуз",
        "три кота", "малышарик", "профпресс", "эксмо", "феникс",
    ],
    "Канцтовары": [
        "ручк", "карандаш", "тетрад", "альбом", "краск", "фломастер",
        "пластилин", "ножниц", "клей", "линейк", "пенал", "папк", "блокнот",
        "маркер", "точилк", "ластик", "файл", "скрепк", "степлер", "стикер",
        "папка для тетрад", "папка для труд", "папка на молни",
    ],
    "Украшения": [
        "украшен", "браслет", "серьг", "колье", "ободок", "заколк",
        "резинк для волос", "бусы", "кольцо", "обод", "краб-заколк",
        "лента", "набор украш", "бижутер", "подвеск", "брошь",
    ],
    "Сумки и рюкзаки": [
        "рюкзак", "сумк", "портфель", "ранец", "мешок для обув",
    ],
    "Спорт": [
        "велосипед", "самокат", "ролик", "коньк", "лыж", "мяч", "ракетк",
        "скейт", "беговел", "ледянк", "клюшк", "лопат", "маск", "круг",
        "каталк", "санк", "ватрушк", "батут", "боксерск",
    ],
    "Крупное": [
        "коляск", "кроватк", "манеж", "автокресл", "стол детск",
        "стул детск", "ходунк", "качел", "шезлонг", "люльк",
        "велокол", "батут", "горк", "качалк",
    ],
    "Детские товары": [
        "пустышк", "бутылочк", "подгузник", "горшок", "ванночк", "термометр",
        "молокоотсос", "конверт", "пеленк", "слинг", "ниблер", "поильник",
        "прорезыватель", "бортик", "наш", "плед", "бандаж", "нагрудник",
        "соск", "грелк", "ситечк", "держатель соск", "комплект пеленок",
    ],
    "Игрушки": [
        "игрушк", "кукл", "пупс", "машинк", "конструктор", "мозаик", "пазл",
        "набор игров", "мягк", "плюш", "погремушк", "качалк", "зайк", "мишк",
        "лисичк", "собачк", "кошечк", "тигр", "слон", "жираф", "единорог",
        "робот", "трансформер", "динозавр", "дракон", "лошадк", "овечк",
        "медвед", "заяц", "волк", "лис", "котик", "щенок", "попугай",
        "обезьян", "черепах", "крокодил", "пингвин", "дельфин",
        "набор посуды", "кухн", "набор инструмент", "набор доктор",
        "набор парикмахер", "набор кулинар", "набор турист",
        "интерактивн", "музыкальн", "развивающ", "сортер", "пирамидк",
        "каталк", "юла", "волчок", "кубик", "лото", "домино",
        "настольн игр", "монополи", "шахмат", "шашк",
        "step puzzle", "степ пазл", "trefl", "educa", "defa", "zhorya",
        "abtoys", "1toy", "технок", "полесь", "нордпласт",
        "коврик обуч", "коврик развив", "набор обучающ",
        "волшебн палочк", "игровой набор", "чемоданчик",
    ],
}
...
async def process_images(images: list, current_date: str, reply_msg):
    try:
        ...
        for item, (found, cat_name) in zip(items, cat_results):
            ...
            detected = detect_category(item.get('name', ''))
            cat_debug = f" (кат:{detected or 'нет'})"
            lines.append(f"  • {item['name']} — {item['price']} руб. × {item['qty']} шт.{cat_info}{cat_debug}")
